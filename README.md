...
This Web Application Project is a video sharing platform developed with ASP.NET MVC programming language. The main purpose of the project is to apply sentiment analysis in the comments.
